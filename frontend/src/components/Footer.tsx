...
export function Footer() {
  return (
    <footer className="border-t border-hairline py-14 bg-canvas-2">
      <div className="max-w-container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          {/* Brand */}
          <div className="flex flex-col items-center md:items-start gap-1.5">
            <span className="chrome font-display font-extrabold text-lg tracking-[0.04em]">
              BLENDING WITH JUNIOR
            </span>
            <span className="text-xs text-text-muted tracking-wide">
              Professional Auto Detailing · San Antonio, TX
            </span>
            <a
              href="tel:+12109921268"
              className="text-xs text-text-secondary hover:text-gold transition-colors duration-200 mt-1"
            >
              <span className="stars mr-2">★★★★★</span>(210) 992-1268
            </a>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-0.5">
              ...
              <span className="text-[10px] text-text-muted leading-none">Zelle</span>
            </div>
            <div className="flex flex-col items-center gap-0.5">
              <a
              ...
              <span className="text-[10px] text-text-muted leading-none">Cashapp</span>
            </div>
          </div>
